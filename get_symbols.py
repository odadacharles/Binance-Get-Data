...
for s in exchange_info['symbols']:                              #Loop through the symbols in the exchange info and append all symbols to the trading_pairs list
...
Symbol_DF.to_csv('binance_trading_pairs.csv', index=False)      #Convert the dataframe to a csv file, 'index = False' will prevent creation of a second index when the csv file is created
