...
Symbol_DF.to_csv('binance_BTC_trading_pairs.csv', index=False)      #Convert the dataframe to a csv file, 'index = False' will prevent creation of a second index when the csv file is created
